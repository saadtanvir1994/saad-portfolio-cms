  ...
  return (
    ...
    >
      ...
      <Image
        ...
        alt="image"
        className="animate-slide-from-top absolute inset-0 -z-10 size-full rounded-lg object-cover brightness-50 transition-all duration-500 [clip-path:inset(0_0_100%_0)] group-hover:[clip-path:inset(0_0_0%_0)]"
        height={320}
        width={220}
        loading="lazy"
      />
